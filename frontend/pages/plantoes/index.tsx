...
import DashboardLayout from '../../components/plantoes/DashboardLayout'
  ...
  const dashboardContent = (
    <>
      ...
      <div style={{
        ...
        {[
          { label: 'Calendário / Rodízios', desc: 'Visualizar e gerenciar escalas', icon: '📅', href: '/plantoes/calendar' },
          { label: 'Trabalhadores', desc: 'Cadastro de profissionais', icon: '👷', href: '/plantoes?tab=workers' },
          { label: 'Feriados', desc: 'Gerenciar feriados', icon: '🎉', href: '/plantoes?tab=holidays' },
          { label: 'Atribuições', desc: 'Atribuições manuais', icon: '📋', href: '/plantoes?tab=assignments' },
          { label: 'Relatórios', desc: 'Relatórios de plantões', icon: '📊', href: '/plantoes?tab=reports' },
        ].map(item => (
          <a
            key={item.label}
            href={item.href ?? '#'}
